...
function initializeConfig() {
    if (window.BRIEFING_CONFIG) {
        ...
        // Fallback: derive API URL from current page origin
        console.warn('⚠️ BRIEFING_CONFIG not found. Using fallback config from page origin.');
        API_BASE_URL = window.location.origin;
        API_BASE = '/api/v1';
        BRIEFING_ENDPOINT = `${API_BASE_URL}${API_BASE}/briefing`;
        console.log('🔧 Fallback API config:', { API_BASE_URL, API_BASE, BRIEFING_ENDPOINT });
    }
}
